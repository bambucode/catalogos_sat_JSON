# Catálogos CFDI 4.0 del SAT

Este repositorio contiene los catálogos de CFDI 4.0 que el SAT [publica en su
...
[Descargar todos los catálogos en formato ZIP](https://github.com/bambucode/catalogos_sat_JSON/archive/refs/heads/cfdi-4.0.zip)
